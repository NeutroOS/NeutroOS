...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('NeutroArt/NeutroArticon.png'))
        ...
        pix_36 = QAction("36px", self)
        b_size.addAction(pix_36)
        pix_36.triggered.connect(self.Pixel_36)
        ...
        brown.triggered.connect(self.redColor)
    ...
    def pinkColor(self):
        self.brushColor = Qt.pink

    def brownColor(self):
        self.brushColor = Qt.brown

    def orangeColor(self):
        self.brushColor = Qt.orange

    def purpleColor(self):
        self.brushColor = Qt.purple

    def lgreenColor(self):
        self.brushColor = Qt.lightgreen

    def lblueColor(self):
        self.brushColor = Qt.lightblue
